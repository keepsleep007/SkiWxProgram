	...
	<view class="page-news">
		...
		<scroll-view class="scroll-container" scroll-y="true" refresher-enabled="true" :refresher-triggered="triggered" :scroll-into-view="scrollIntoViewId" :refresher-threshold="100" refresher-background="#efeff4"
			...
			<uni-list class="uni-list">
				<uni-list-item :border="false" class="uni-list-item" title=" " v-for="carItem in dataList" :key="carItem.id" :to="'/pages/club/car-page-info?id='+carItem.id">
					<template v-slot:body>
						<view class="media-item">
							...
							<view class="item-view">
								...
								<!-- <text class="info-text edit-btn" style="background-color: #ecf5ff; color:#409eff; border: 1px solid #409eff;">编辑</text> -->
...
<script>
	import filterBar from './car-page_filter_bar';
	import {
		getToken
	} from '@/utils/auth';
	export default {
